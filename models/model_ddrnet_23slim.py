...
#############################################################
#
#   model: DDRNet (from paper "Deep Dual-resolution Networks for Real-time and Accurate Semantic Segmentation of Road Scenes")
#
#   paper link: https://arxiv.org/abs/2101.06085
#
#   paper info: Yuanduo Hong, Huihui Pan, Weichao Sun, Yisong Jia
#               Deep Dual-resolution Networks for Real-time and Accurate Semantic Segmentation of Road Scenes
#               2021
#
#   github link: original code https://github.com/ydhongHIT/DDRNet?tab=readme-ov-file
#   Implemented code from https://github.com/xiaoyufenfei/Efficient-Segmentation-Networks
#
...
def DDRNet(pretrained=False, num_classes=19):
    ...
    if pretrained:
        checkpoint = torch.load(r'E:\pytorch_projects\test\models\checkpoint\DDRNet23s_imagenet.pth', map_location='cpu')
...
# def get_seg_model(cfg, **kwargs):
#     model = DDRNet(pretrained=False, num_classes=19)
#
#     return model
