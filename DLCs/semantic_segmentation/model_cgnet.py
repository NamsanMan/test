...
#
#   paper info: Wu, Tianyi and Tang, Sheng and Zhang, Rui and Cao, Juan and Zhang, Yongdong
#               CGNet: A Light-weight Context Guided Network for Semantic Segmentation
#               IEEE Transactions on Image Processing 2020
# 
#   github link: https://github.com/wutianyiRosun/CGNet
#
#   license info: MIT license 
#
#
#   How to Use
#   *CamVid 11 label 기준 Patch를 입력에 사용함을 확인 (360x360)
#   *논문에서 Cross Entropy Loss 사용 확인됨
#
#   < import model >
#   from model_cgnet import Context_Guided_Network as CGNet
#   
#
#   < init >
#   model = CGNet(classes=11, M=3, N=21)        # M과 N은 stage 2, 3의 Block 수를 의미하며, 설정된 값은 CamVid 데이터에 대한 official 설정에 해당
...
# https://github.com/wutianyiRosun/CGNet/blob/cfccea377a6f0a659e807e8759c82dbffba02d7f/model/CGNet.py
# CGNet.py
